...
export const getBillByBillId = ({
    ...
    return db.collection(bill, 'tag')
        ...
        .then(({ result }) => {
            ...
            return {
                bill: result.data && result.data.length === 1 ? result.data[0] : null
            };
    ...
    return db.collection(bill, 'tag')
        ...
        .then(({ result: { data } }) => {
            ...
            return db.collection('bill')
                ...
                .groupBy('billTime')
                .groupField('sum(incomeAmount) as totalIncomeAmount, sum(expensesAmount) as totalExpensesAmount')
            ...
            _.each(statisticsList, statisticsItem => {

                result.push({
                    billTime: statisticsItem.billTime,
                    totalExpensesAmount: statisticsItem.totalExpensesAmount,
                    totalIncomeAmount: statisticsItem.totalIncomeAmount,
                    billList: _.filter(billList, billItem => billItem.billTime === statisticsItem.billTime)
                });
...
export const getBillStatisticsInfo = ({
    userId,
    tagId,
    startTime,
    endTime
...
export const getBillStatisticsInfoGroupByTag = ({
    billType,
    userId,
    startTime,
    endTime
...
export const getBillStatisticsInfoGroupByDay = ({
    billType,
    userId,
    startTime,
    endTime
...
export const getBillStatisticsInfoGroupByMonth = ({
    billType,
    userId,
    startTime,
    endTime
